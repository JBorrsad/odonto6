...
public class PatientController {
    ...
    public ResponseEntity<Object> getPatientOdontogram(@PathVariable String id) {
        try {
            PatientDTO patient = patientService.getPatientById(id);
            // En un caso real, necesitaríamos un servicio específico para obtener el odontograma
            // Por ahora, simplemente verificamos que el paciente existe
