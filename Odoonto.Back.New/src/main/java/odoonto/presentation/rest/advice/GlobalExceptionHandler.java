...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Maneja excepciones genéricas del dominio
     */
    ...
    /**
     * Maneja excepciones de tipo InvalidToothFaceException
     */
    ...
    /**
     * Maneja excepciones de tipo DuplicateLesionException
     */
    @ExceptionHandler(DuplicateLesionException.class)
    public ResponseEntity<ErrorResponse> handleDuplicateLesion(DuplicateLesionException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new ErrorResponse("DUPLICATE_LESION", ex.getMessage()));
    }
    
    /**
     * Maneja excepciones de tipo InvalidAppointmentTimeException
     */
    ...
    /**
     * Maneja otras excepciones no capturadas específicamente
     */
